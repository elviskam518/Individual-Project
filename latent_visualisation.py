...
def run_latent_visualisation(
    ...
    pca_cvae_raw, var_cvae = compute_pca(z_cvae_raw)
    
    plot_comparison_gender(
        pca_baseline, pca_cvae_raw, gender_labels,
    ...
    if modes:
        ...
        for mode_name, mode_model in modes.items():
            ...
            metrics_mode = compute_separation_metrics(z_mode_raw, gender_labels)
